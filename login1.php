<!DOCTYPE html>
<html>
<head><title>Log In_1</title>
</head>
<body background="pic.jpg">
<h1 style="color:white">MyMail</h1>
<?php
session_start();
...
if(!isset($_SESSION['SESS_MEMBER_ID'])){
	//echo $var;
?>
<form name="loginform1" action="login_exec1.php" method="post">
<table>
  <tr>
    <td colspan="2">
...
?>
<h2><a style="color:white" href="Userprofile1.php">Profile</a></h2>
<?php
}
?>
</body>
